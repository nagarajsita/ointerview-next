...
export default function ScheduleInterview({ children }: { children: ReactNode }) {
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md relative animate-modal-appear">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">Create a new interview session for a candidate</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">Automatically generated unique room identifier</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">Select a date and time for the interview session</p>
              </div>
