...
export default function InternalLayout({
  ...
  return (
      <div className="bg-grid-zinc-100 antialiased flex flex-col h-screen w-full md:w-auto">
        ...
        {/* Header Section */}
        <header className="flex justify-between items-center border shadow-lg ring-2 bg-white m-4 mb-2 rounded-full px-4 py-2">
          ...
          <div className="flex gap-5 justify-center items-center h-[1lh]">
          <SessionDetails/>
          <Logout/>
          </div>
        </header>
